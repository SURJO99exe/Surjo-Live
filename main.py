#ONLY ONE THE KING OF COMMITTIY : Surjo Live
#INSTAGRAM : @surjolive
#YOUTUBE : @surjolive
#TELEGRAM : @surjolive
...
async def MaiiiinE():
    ...
    if not os.path.exists("SurjoLive.txt"):
        print("❌ SurjoLive.txt not found. Create it with {\"UID\": \"PASSWORD\"}")
        return None
    with open("SurjoLive.txt", "r") as f:
        creds = json.load(f)
    if not creds:
        print("❌ SurjoLive.txt is empty or invalid JSON")
        return None
